...
function getDefaultValues({ currentLine, schema, wordsBeforePosition, }) {
    const suggestions = [];
...
function localCompletions(schema, initiatingDocument, params, onError) {
    ...
    if ((0, ast_1.isFirstInsideBlock)(position, foundBlock.definingDocument.lines[position.line].untrimmedText)) {
